...
namespace WindowsFormsApp1
{
    ...
    public partial class Form2 : Form
    {
        ...
        {
            con.Open();
            OracleCommand cmd = new OracleCommand("insert into daira.society(society_code,society_name,society_head) values ('" + txtSocietyCode.Text + "','" + txtSocietyName.Text + "','" + txtSocietyHead.Text + "')",con);
            cmd.ExecuteNonQuery();
